...
import CustomizedTourPageContent from "@/components/mains/customized-tour-page/customized-tour-page-content";
...
export default async function CustomizedTourPage() {
  ...
  return (
    <div className={classes.customizedTourPageRoot}>
      ...
      <CustomizedTourPageContent tourCategoriesData={tourCategoriesData} />
    </div>
  );
}
