...
export default function LandingPageDetail({ page }: LandingPageDetailProps) {
  const additionalImageSlides = page.additionalImageUrls.map((url) => ({
    item: url
  }));
    ...
    <div className={classes.pageDetailContainer}>
      <Stack gap={'sm'} mb={'lg'}>
        ...
        {page.destinations.length > 0 && (
          <Group gap={4}>
            ...
            <Text fz={15} c={'white'}>{page.destinations.join(', ')}</Text>
          </Group>
        )}
      </Stack>
      <Grid gutter={'xl'} classNames={{
        ...
        <GridCol span={{ base: 12, sm: 12, md: 8, lg: 8, xl: 8 }} classNames={{
          ...
          {page.additionalImagesPosition === 'top' && renderAdditionalImagesCarousel()}
          {page.videoPosition === 'top' &&
            renderVideoSection(page.videoUrl || undefined,
          ...
          {page.type === 'contact' && (
            <Paper shadow="xs" mt={'md'} mb={'md'} p={'md'} bg={'white'} bdrs={'lg'}>
              <ContactForm
          ...
          {page.additionalImagesPosition === 'bottom' && renderAdditionalImagesCarousel()}
        ...
        <GridCol span={{ base: 12, sm: 12, md: 4, lg: 4, xl: 4 }} classNames={{
          ...
          <Stack gap={'lg'}>
            ...
            <Paper shadow="0" bg={'transparent'} mb={'lg'} pt={'sm'} pb={'sm'} pl={'md'} pr={'md'} classNames={{
              root: classes.whyBox
            }}>
              <Stack gap={'sm'}>
